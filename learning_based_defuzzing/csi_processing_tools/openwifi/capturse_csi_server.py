...
UDP_IP = "192.168.0.200" #Local IP to listen
...
if os.path.exists("captured_csi.txt"):
    os.remove("captured_csi.txt")
csi_fd=open('captured_csi.txt','a')
